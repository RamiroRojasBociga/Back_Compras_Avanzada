...
public class ProductoResponseDto {
    ...
    public Float getPorcentajeImpuesto() { return porcentajeImpuesto; }
    public void setPorcentajeImpuesto(Float porcentajeImpuesto) { this.porcentajeImpuesto = porcentajeImpuesto; }
